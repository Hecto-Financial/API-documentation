...
|               |                             | ※ fixed value                                                               |               |          |                             |
| mchtId        | Merchant ID                 | Unique Merchant ID provided by Hecto Financial                              | AN(8)         | ●        | “midtest”                   |
| mchtTrdNo     | Order number                | Merchant Order Number                                                       | AN(100)       | ●        | "OID2021083012345"          |
|               |                             | * Exclude Korean                                                            |               |          |                             |
| mchtCustId    | Customer ID                 | Unique Customer ID or Unique Key from merchant (AES encryption)             | AN(100)       | ○        | “honggildong”               |
...
| custAcntSumry | Deposit account code content | Code name that will be on customer’s account ※ Full-width letters used (7 letters) (AES encryption) | AN(14) | ● | “Hong Gildong” (in Korean) |
...
| macntSumry    | Bank code content of main account | Code content that will be on the main account (for direct contract with bank) ※ Full-width letters used (6 letters) (AES encryption) Required if it is directYn Y (direct contract) | AN(12) | ○ | |
