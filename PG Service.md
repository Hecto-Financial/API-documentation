...
| `mchtCustNm`  | Customer Name            | Merchant Customer Name                              | AHN(30)       | ●        | "Hong Gil Dong"            |
| `mchtCustId`  | Merchant Customer ID     | Merchant customer ID                                | AHN(50)       | ●        | "HongGilDong"              |
| `email`       | Customer Email           | Merchant customer email address                     | AN(60)        | ○        | "HongGilDong@example.com"  |
...
Refer to [5.5 Notification Parameter].

---

This response covers section 12. If you need additional sections filled in or further adjustments, please let me know!
